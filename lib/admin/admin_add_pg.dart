...
class AddPGScreenAdmin extends StatefulWidget {

  final String pgId;
  AddPGScreenAdmin({required this.pgId});

  @override
  State<AddPGScreenAdmin> createState() => _AddPGScreenAdminState();
}

class _AddPGScreenAdminState extends State<AddPGScreenAdmin> {
